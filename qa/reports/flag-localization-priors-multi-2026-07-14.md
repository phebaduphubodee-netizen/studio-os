...
**macro localization-recall 1.0** (by-expected 1.0; 7/7 should-flag lanes exercised)  ·  on-target precision 0.951  ·  overfire mutations 0  ·  blind classes: none  ·  unwired (never-exercised) classes: none  ·  backstopped-only classes: none
...
- **anomaly**: READ
- **confidence**: READ
- **prior_band**: READ — 2 kind-priors docs feed anomaly's corpus band + confidence's prior_kind corroboration (and the size_off_prior_band class)
