# Stage 04 — Visualization · PRJ-2026-002   [Gates 1–2]
## Inputs
...
## Outputs (required)
- batch-manifest.md (payload version, seeds, ControlNet weights) · renders in assets/projects/PRJ-2026-002/renders/ · scorecards → ../05_qa/
## Gate
