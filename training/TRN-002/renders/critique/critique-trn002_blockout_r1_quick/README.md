...
1. เปิด Gemini
2. แนบไฟล์ **`trn002_blockout_r1_quick.png`** — ไฟล์เดียวเท่านั้น
...
TRN-002 round 1 CLAY BLOCKOUT (geometry only, form light, no materials): judge composition/proportion/placement as a designer; materials+light are later rounds