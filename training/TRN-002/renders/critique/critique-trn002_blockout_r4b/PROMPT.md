...
ลงพื้น ยกเป็นโต๊ะเครื่องแป้ง (บน ~0.875) ชนตู้ชั้นโค้งมุมห้องที่มีช่องชั้นเปิด
สองช่อง + TV เหนือคอนโซล + เก้าอี้เครื่องแป้ง (ที่นั่ง ~0.45 พนัก ~0.78) หน้าโต๊ะ,
...
บานตู้ 506-509 สามช่วงเท่ากัน, ประตู 845, ช่องชั้นตู้โค้ง z 0.82-1.33 กับ 1.35-1.92
...
(4) อาการที่รอบก่อนโดนติ: แคปซูลตั้ง+ก้อนขั้นบันไดที่หัวเตียง / bolster หาไม่เจอ /
เก้าอี้ตันสูงจนสอดเข่าใต้โต๊ะไม่ได้ / ตู้ชั้นโค้งตัน — หายหรือยัง
