...
ลงพื้น ยกเป็นโต๊ะเครื่องแป้ง (บน ~0.875) ชน étagère มุมห้องแบบเปิดหน้าโล่ง:
แผงหลังไม้ต่อเนื่องถึงยอด (~2.92 — เสมอแนว bulkhead ฝั่งตู้) + แผ่นชั้นบางมุมโค้ง
3 แผ่น ไม่มีก้อนตันเหนือฐาน + TV เหนือคอนโซล + เก้าอี้เครื่องแป้ง (ที่นั่ง ~0.45
พนัก ~0.78) หน้าโต๊ะ,
...
บานตู้ 506-509 สามช่วงเท่ากัน, ประตู 845, แผ่นชั้น étagère z 1.34-1.39 /
1.91-1.97 / 2.38-2.46 ยอดแผงหลัง 2.92 (subpixel fits สองชุด seed ต่างกัน
ตรงกัน ≤3mm)
