...
status: STAGED for promotion -> knowledge/classifications/plan-reading-conventions.md (fills the vault gap confirmed by knowledge-manager: no furniture-plan symbol / orientation / BF-code guide existed)
