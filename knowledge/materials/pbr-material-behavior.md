...
## 5. สเกลเท็กซ์เจอร์ไม่ใช่ปุ่มปรับหน้าตา / Texture scale is not an appearance knob

> **PROVENANCE.** คำสั่งเจ้าของ 2026-08-24: **"แก้ผิวพรม ไม่ถอยสเกล"** — ให้ไว้ตอนที่ builder เสนอจะ
> ลด `tile_m` ของพรมเพื่อให้ผิวดูดีขึ้นในเฟรม · แถวคำสั่งนั้น (`ORD-2026-08-24-fix-rug-surface-not-scale`)
> ถูกเสนอถอน 2026-08-28 เพราะพรมกลายเป็นของซื้อไปแล้วและ assertion ของมันเฝ้าโค้ดที่ไม่วิ่ง —
> **แต่ประโยคระดับคลาสมีค่ากว่าตัวพรม จึงย้ายมาที่นี่ก่อนถอน ไม่ถอนเปล่า ๆ**

**กฎ:** `tile_m` (หรือสเกล UV ใด ๆ) คือ **ข้อเท็จจริงเชิงกายภาพของวัสดุ** ไม่ใช่ตัวแปรความสวย ·
ค่าที่ถูกคือค่าที่ทำให้ลายพิมพ์ออกมาเท่าขนาดจริงของมันในโลก (ลายไม้กว้างเท่าแผ่นจริง · ขนาดขนพรมเท่าของจริง)
**ห้ามถอยสเกลของผู้ผลิตเพื่อแก้หน้าตาในเฟรม** ถ้าผิวดูไม่ดี ให้แก้ที่ผิว — roughness, normal, ขน,
การรับแสง — หรือเปลี่ยนวัสดุ

**ทำไมมันเป็นกฎ ไม่ใช่รสนิยม:** การถอยสเกลทำให้ภาพดูดีขึ้นทันทีโดยไม่แก้อะไรเลย และมันโกหกสองชั้นพร้อมกัน
— บอกว่าวัสดุมีขนาดลายอื่น และทำให้ทุกการวัดที่อ้างอิงลายนั้นผิดตามไปหมด · เรโปนี้วัดพื้นที่เรนเดอร์ผิดไป
**1.41 เท่า** และพรมผิดไป **4.81 เท่า** มาแล้ว ทั้งสองครั้งไม่มีเครื่องไหนเห็น เพราะสเกลไม่เคยถูก assert
ตอน ingest — ดู `texture-scale-asserted-and-instrument-blindness` และกฎ R8 (scale is ASSERTED on every
ingest, never assumed)

**คู่กัน:** ถ้าค่าที่ถูกต้องทำให้เฟรมดูแย่ นั่นคือข้อมูลว่าวัสดุนั้นผิดสำหรับงานนี้ ไม่ใช่ข้อมูลว่าสเกลผิด

## 6. Cross-refs & gaps / อ้างอิงข้ามไฟล์และช่องว่าง
