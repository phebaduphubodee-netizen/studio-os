...
## คำสั่งเจ้าของหลังดูบันได (verbatim, 2026-08-22)

> หาขนาดเตียงมาตรฐานแล้วขนาดให้เท่านั้นแล้วปรับของรอบ ๆ ให้มาชิดเตียงเอา

การอ่าน (builder — เจ้าของแก้ได้): เป้าขนาดเตียงเปลี่ยนจาก "สี่เหลี่ยมที่วาดในแบบ 2149x2000"
เป็น "ขนาดเตียงมาตรฐาน" และของรอบเตียง (โต๊ะข้าง 2 ตัว + ม้านั่งปลายเตียง) ขยับเข้าประชิดเตียง
แทนที่จะยึดตำแหน่งที่วาดไว้กับเตียง 7 ฟุต → ORD-2026-08-22-bed-standard-size-hug + D-114
(มาตรฐานที่เลือก + เลขทั้งหมด) · คำสั่ง ORD-2026-08-18-bed-too-small ถูก retire โดย D-114
เพราะไม้บรรทัดของมัน (สี่เหลี่ยมในแบบ) ถูกคำสั่งใหม่นี้แทนที่ด้วยคำพูดเจ้าของเอง
